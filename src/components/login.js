...
import { loginMutation, gLoginMutation, signupMutation, verifyMutation, completeMutation, forgotPasswordMutation, verifyPasswordMutation } from "@/hooks/auth";
    ...
    return (
        <div className="flex flex  ">
            <div
                ...
                className="flex flex-col px-8 rounded-xl items-center bg-[#3c498b4d]"
            >
                <div className="flex flex-col w-full items-center">
                    ...
                    <p className="text-sm text-white mb-8">
                        {step == 0 ? "Please enter your details to login" : "complete rest of ypur details"}
                    </p>
                    {step == 1 && <>
                        ...
                        < div className="self-stretch mb-1 flex flex-row items-center justify-start gap-[0.75rem] max-w-full mq900:flex-wrap">
                            ...
                            <div className="flex-1 rounded-2xl bg-gray-100 box-border overflow-hidden flex flex-row items-center justify-start py-[0.625rem] pr-[0rem] pl-0 xs:pl-[1.5rem] gap-[0.5rem] max-w-full border-[1px] ">
                                <input
                                    className="[border:none] [outline:none] bg-[transparent] h-[1.5rem] flex flex-row items-center justify-start font-body-small font-normal text-[1.25rem] text-text3 max-w-[231%] shrink-0 "
                    ...
                    <button onClick={() => {
                        if (step == 0) {
                            ...
                            complete({ phone_no: phone, country_code: code.value, email: email })
                        }
                    }} className="w-[80%] bg-orange-500 text-white py-3 [border:none] rounded-2xl font-bold mb-4">
                    ...
                    {step == 0 && <>
                        ...
                        }} className="w-[80%] [border:none]  bg-white text-lg font-semibold text-secondary py-2.5 rounded-2xl flex items-center justify-center mb-1 whitespace-nowrap">
                            <img
                        ...
                        <div className="w-[80%] text-sm flex justify-center gap-1 mb-6" ><div className="text-white" >{"Dont have an account "} </div>{` `}
                            <a onClick={() => {
                                setStage("Signup")
                            }} className="text-primary cursor-pointer underline">
                                Sign Up?
        ...
        <div className="flex flex px-12 py-4  ">
            ...
            >
                <div className="flex flex-col w-full items-center">
                    ...
                    {
                        step == 1 && <div className="self-stretch w-full  mb-6 flex flex-row items-center justify-center">
                            <OtpInput
                                ...
                                inputStyle="[border:none] [outline:none] bg-gray-100 h-[1.5rem] rounded-md justify-center font-body-small font-normal text-[1.25rem] text-text3 "
                            />
                        </div>
                    }
                    ...
                    <button onClick={() => {
                        if (step == 0) {
                            ...
                            mutate({ phone_no: phone, password, email, name, country_code: code.value })
                        } if (step == 1) {
        ...
        <div className="flex flex px-12 py-4  ">
            ...
            >
                <div className="flex flex-col w-full items-center">
                    ...
                    {step == 0 && <div className="self-stretch mb-1 flex flex-row items-center justify-start gap-[0.75rem] max-w-full mq900:flex-wrap">
                    ...
                    {
                        step == 1 && <> <div className="self-stretch mb-1 flex flex-row items-center justify-start gap-[0.75rem] max-w-full mq900:flex-wrap">
                            <OtpInput
                                value={OTP}
                                onChange={setOTP}
                                numInputs={6}
                                renderSeparator={<span className="w-2" ></span>}
                                renderInput={(props) => <input  {...props} />}
                                inputStyle="[border:none] [outline:none] bg-gray-100 h-[1.5rem] rounded-md justify-start font-body-small font-normal text-[1.25rem] text-text3 "
                            />
                        </div>
                            <div className="flex-1 rounded-2xl bg-gray-100 box-border mb-1 overflow-hidden flex flex-row items-center justify-start py-[0.625rem] pr-[0rem] pl-0 xs:pl-[1.5rem] gap-[0.5rem] w-full border-[1px]">
                                <input
                    ...
                    <button onClick={() => {
                        ...
                        {step == 0 ? "Send OTP" : step == 1 ? "Verify OTP" : "Change Password"}
                    </button>
                    <div className="w-[80%] text-sm flex justify-center gap-1 mb-6" ><div className="text-white" >{"Back to "} </div>{` `}
                        <a onClick={() => {
                            setStage("Login")
                        }} className="text-primary cursor-pointer underline">
                            Sign in?
...
const ModalDisp = ({close}) => {
    ...
    return (<div>
        ...
        {stage == "ForgotPassword" && <ForgotPassword close={close} setStage={setStage} />}
    </div>)
}
