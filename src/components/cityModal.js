    ...
    <>
      <Modal style={style} open={open} onClose={onClose}>
        <div className=" flex flex-col items-center w-full h-[33.5rem] relative shadow-[0px_6px_24px_-4px_rgba(18,_25,_56,_0.1),_0px_12px_48px_4px_rgba(18,_24,_56,_0.15)] [backdrop-filter:blur(48px)] rounded-[32px] bg-white overflow-y-auto overflow-x-hidden text-[1.5rem] text-secondary font-button-large mq762:h-auto mq762:min-h-[536]">
            ...
            {options.map((option) => {
              ...
              return (
                <div
                  ...
                  className={`w-[7rem] mt-4 h-[6.5rem] cursor-pointer shadow-[0px_6px_24px_-4px_rgba(18,_25,_56,_0.1)] rounded-2xl  overflow-hidden flex flex-col items-center justify-center py-[1rem] px-[1.656rem] ${
          ...
          <button
        onClick={onClick}
          className="cursor-pointer [border:none] py-[0.8rem] pr-[1.968rem] pl-[2.468rem] bg-secondary w-[13.813rem] shadow-[0px_8px_24px_rgba(57,_26,_0,_0.15)] rounded-2xl overflow-hidden shrink-0 flex flex-row items-center justify-center box-border gap-[1rem]"
          // onClick={onCustomerDetailsClick}
        >
          <img
            className="h-[2rem] w-[2rem] relative overflow-hidden shrink-0 hidden]"
            alt=""
