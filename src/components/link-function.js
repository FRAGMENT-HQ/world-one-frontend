const LinkFunction = ({ reliability, trustOurExperienceAndSecu, imgSrc }) => {
  ...
  return (
    ...
    >
      <div className=" relative text-left ml-4 h-[90%] w-[90%] text-5xl tablet:text-[2vw] flex flex-col items-start justify-end gap-2 -mt-5  py-4 ">
        <div className="pt-8 inline-block text-white font-semibold px-3 ">
          {reliability}
        </div>
        <div className=" text-xl tablet:text-[1.5vw] text-white font-medium text-left px-3">
