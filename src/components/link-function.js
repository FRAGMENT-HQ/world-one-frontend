...
const LinkFunction = ({
  ...
  return (
    <div className="w-[372px] rounded-3xl bg-white shadow-[0px_6px_24px_-6px_rgba(34,_46,_106,_0.15)] overflow-hidden shrink-0 flex flex-col items-center justify-center py-12 px-6 box-border gap-[24px] max-w-full text-left text-5xl text-secondary font-body-small">
      <img
