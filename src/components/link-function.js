const LinkFunction = ({ reliability, trustOurExperienceAndSecu, imgSrc }) => {
  ...
  return (
    <div
      ...
      style={imgStyle}
      className={`w-[18rem] h-96 tablet:w-[19.5vw] tablet:h-[25vw]  mw-80 h-96 p-0 bg-no-repeat flex flex-col items-center justify-center text-left text-5xl text-secondary font-body-small  `}
    >
