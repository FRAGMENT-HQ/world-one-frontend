    ...
    <div className="flex-1 max-h-[12rem] shadow-[1px_1px_2px_rgba(248,_248,_248,_0.05)_inset,_0px_8px_24px_rgba(19,_26,_60,_0.15)] rounded-2xl bg-gray-200 overflow-hidden flex flex-col items-center justify-center py-[1rem] px-[1.5rem] box-border gap-[1rem] min-w-[14.313rem] max-w-[14.563rem] text-left text-[1.5rem] text-white font-lato">
      ...
      <div className="self-stretch flex flex-col items-center justify-center gap-[0.5rem] text-[1.25rem] text-text5 font-body-small">
        <div className="self-stretch flex flex-row items-center justify-between gap-[1.25rem]">
          <div className="relative leading-[2rem] font-medium inline-block min-w-[2.188rem] mq450:text-[1rem] mq450:leading-[1.625rem]">
            Buy
          </div>
        ...
        <div className="self-stretch flex flex-row items-center justify-between gap-[1.25rem]">
          <div className="relative leading-[2rem] font-medium inline-block min-w-[2.125rem] mq450:text-[1rem] mq450:leading-[1.625rem]">
            Sell
          </div>
