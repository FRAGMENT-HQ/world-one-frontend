...
const FrameComponent = ({
  ...
  const animationControllerStyle = useMemo(() => {
    return {
      bottom: propBottom,
    };
  }, [propBottom]);
  ...
  return (
    <div
      className="w-[49%]  mb-8 top-[0px] left-[0px] rounded-13xl bg-darkslateblue-400 shadow-[0px_6px_24px_-4px_rgba(18,_25,_56,_0.1),_0px_12px_48px_4px_rgba(18,_24,_56,_0.15)] [backdrop-filter:blur(48px)] overflow-hidden shrink-0 flex flex-row items-start justify-start py-8 px-16 box-border gap-[48px] max-w-full text-left text-13xl text-text5 font-lato mq825:flex-wrap"
    ...
    >
      ...
      <div
        ...
        style={animationControllerStyle}
      />
    </div>
  );
};
