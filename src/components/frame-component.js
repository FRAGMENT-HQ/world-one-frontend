    ...
    >
      ...
      <div className="flex-1 flex flex-col items-start justify-start gap-[32px] max-w-full">
        <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
          ...
          <div className="self-stretch relative text-base mq450:text-base mq450:leading-[22px]">{`Exchange major world currencies with competitive rates and exceptional service, ensuring seamless transactions for your convenience. `}</div>
        </div>
