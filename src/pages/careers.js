  ...
  return (
    ...
    >
      ...
      <section className=" flex   flex-col items-start justify-start gap-[1.75rem] min-w-full">
        <div className="self-stretch shadow-[0px_6px_48px_-4px_rgba(18,_25,_56,_0.1)] rounded-13xl bg-[#12174E]  flex flex-col items-center justify-center py-[1rem] pb-[4rem] px-[5%] sm:px-[3rem] box-border gap-[2.5rem] max-w-full  mq900:pt-[2.625rem] mq900:pb-[2.625rem] mq900:box-border mq1325:pl-[1.625rem] mq1325:pr-[1.625rem] mq1325:box-border">
          ...
          <div onClick={()=>{
            ...
            <img className="w-10 h-10" src="arrow-right.svg" />{" "}
            <input ref={inputRef} type="file" accept="application/pdf" className="invisible w-0" />
          </div>
        </div>
      </section>
    </div>
